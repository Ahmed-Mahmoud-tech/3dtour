...
// The tour viewer app (Vite client). In production both live on one domain,
// so '' makes links relative; in dev the viewer runs on :5173.
export const VIEWER_URL = process.env.NEXT_PUBLIC_VIEWER_URL || 'http://localhost:5173';
