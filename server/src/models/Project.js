...
const TransitionVideoItemSchema = new mongoose.Schema(
  {
    ...
    // Speed-ramp-baked variants (FFmpeg, see server/src/config/speedRamp.js).
    // The viewer plays these at plain 1x — all speed lives in the file.
    rampedVideoUrl: { type: String, default: "" },
    reverseRampedVideoUrl: { type: String, default: "" },
...
const NavigationHotspotSchema = new mongoose.Schema(
  {
    ...
    // Speed-ramp-baked variants (see TransitionVideoItemSchema)
    rampedTransitionVideoUrl: { type: String, default: "" },
    reverseRampedTransitionVideoUrl: { type: String, default: "" },
    playMode: {
      type: String,
