...
const NavigationHotspotSchema = new mongoose.Schema(
  {
    ...
    playMode: { type: String, enum: ['forward', 'backward'], default: 'forward' },
...
const AppearanceSchema = new mongoose.Schema(
  {
    renderType: { type: String, enum: ['icon', 'image', 'text'], default: 'icon' },
...
const ProjectSchema = new mongoose.Schema(
  {
    ...
    settings: {
      ...
      globalBackgroundAudio: { type: GlobalBackgroundAudioSchema, default: () => ({}) },
    },
