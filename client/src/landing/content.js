...
export const STRINGS = {
  en: {
    ...
    pricing: {
      ...
      packages: [
        {
          name: "Basic",
          price: "EGP 5,900",
          // renew: "then EGP 1,990/yr · or 199/mo",
          tagline: "The 360° photo walk-through",
          features: [
            "Up to 15 panoramic points",
            // "2 filmed video transitions",
            "Up to 5 information points",
        ...
        },
        {
          name: "Premium",
          price: "EGP 22,900",
          // renew: "then EGP 12,900/yr · or 1,290/mo",
          tagline: "Large spaces & full ownership",
          features: [
            "Everything in Professional, plus:",
            "Up to 50 panoramic points",
      ...
      addons: [
        { label: "Extra panoramic point", price: "+EGP 250" },
        // { label: "Extra video transition", price: "+EGP 2,900" },
        { label: "Original photo & video master files", price: "+EGP 2,900" },
        // { label: "Extra language", price: "+EGP 2,900" },
        { label: "Rush delivery (48–72h)", price: "+30%" },
        { label: "Annual update / re-shoot visit", price: "from EGP 3,500" },
      ],
      ownTitle: "Prefer to own it outright?",
      own: [
        {
          name: "Self-host license",
          price: "from EGP 5,000",
          note: "one-time · ends hosting",
          desc: "We hand over the full tour to run on your own server or domain. Included free with Premium.",
        },
        {
      ...
      customNote:
        "First year of hosting is on us — analytics and the messages inbox included. Or take the whole tour to your own server. Yours to keep.",
      // hostingNote:
      //   "First year of hosting is on us — analytics and the messages inbox included. Keep it live after that from EGP 1,990/year, or take the whole tour to your own server. Yours to keep.",
      // customNote:
      //   "Compound, hotel or school? Message us on WhatsApp for a custom quote.",
    },
    how: {
      eyebrow: "The Process",
    ...
    pricing: {
      ...
      packages: [
        ...
        },
        {
          name: "الاحترافية",
          price: "١٠٬٩٠٠ ج.م",
          // renew: "ثم ٤٬٩٩٠ ج.م سنويًا · أو ٤٩٩ شهريًا",
          tagline: "التجربة السينمائية الكاملة",
          features: [
        ...
        },
        {
          name: "المتميزة",
          price: "٢٢٬٩٠٠ ج.م",
          // renew: "ثم ١٢٬٩٠٠ ج.م سنويًا · أو ١٬٢٩٠ شهريًا",
          tagline: "المساحات الكبيرة والملكية الكاملة",
          features: [
            "كل ما في الاحترافية، بالإضافة إلى:",
            "حتى ٥٠ نقطة بانورامية",
            "هوية كاملة على دومينك الخاص",
            "ملفات الصور والفيديو الأصلية",
            "تصدير المشروع — استضافة ذاتية أو جولة أوفلاين",
            "تسليم سريع ٢–٥ أيام",
          ],
          featured: false,
        },
      ],
      addonsTitle: "إضافات واختيارات",
      addons: [
        { label: "نقطة بانورامية إضافية", price: "٢٥٠ ج.م" },
        // { label: "انتقال فيديو إضافي", price: "+٩٠٠ ج.م" },
        { label: "ملفات الصور والفيديو الأصلية", price: "+٢٬٩٠٠ ج.م" },
        // { label: "لغة إضافية", price: "+٢٬٩٠٠ ج.م" },
        { label: "تسليم سريع (٤٨–٧٢ ساعة)", price: "+٣٠٪" },
        { label: "زيارة تحديث/إعادة تصوير سنوية", price: "من ٣٬٥٠٠ ج.م" },
      ],
      ownTitle: "تحب تمتلكها بالكامل؟",
      own: [
        {
          name: "رخصة الاستضافة الذاتية",
          price: "من ٥٬٠٠٠ ج.م",
          note: "مرة واحدة · تنهي الاشتراك",
          desc: "بنسلّمك الجولة كاملة تشتغل على سيرفرك أو دومينك الخاص. مجانية مع باقة المتميزة.",
        },
        {
          name: "نسخة أوفلاين",
          price: "من ٥٬٩٠٠ ج.م",
          // note: "إعادة تصدير سنوية",
          desc: "نسخة تعمل دون اتصال لشاشة داخل المكان أو معرض، مع بقاء جولتك أونلاين. مجانية مع باقة المتميزة.",
        },
      ],
      customNote:
        "أول سنة استضافة علينا — بالتحليلات وصندوق الرسائل. أو خُد الجولة كلها على سيرفرك. تفضل ملكك.",
      // hostingNote:  "أول سنة استضافة علينا — بالتحليلات وصندوق الرسائل. أو خُد الجولة كلها على سيرفرك. تفضل ملكك.",
      // customNote: "كمبوند أو فندق أو مدرسة؟ ابعتلنا واتساب وهنعملك عرض خاص.",
    },
    how: {
      eyebrow: "خطوات العمل",
